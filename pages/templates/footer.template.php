...
<script src="/pages/templates/auth.js?version=<?php echo Utils\General::VERSION?>"></script>
<script src="/pages/templates/utils.js?version=<?php echo Utils\General::VERSION?>"></script>
<?php echo $scripts ?>
</html>